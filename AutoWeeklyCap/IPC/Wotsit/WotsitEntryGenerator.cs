...
public static class WotsitEntryGenerator
{
    ...
    [
        ...
        new("Extract Materia", "extract materia from spriritbonded gear", 61828, () => ActionInstance.Extract.Invoke()),
        new("Repair Gear", "repair gear", 68, () => ActionInstance.SelfRepair.Invoke()),
    ];
