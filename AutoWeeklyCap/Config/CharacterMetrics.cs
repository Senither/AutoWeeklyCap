...
public class CharacterMetrics
{
    ...
    public uint GilEarnedFromSellingItems { get; set; } = 0;
    ...
    public void IncrementGilEarnedFromSellingItemsCounter(uint gilEarned) => GilEarnedFromSellingItems += gilEarned;
}
